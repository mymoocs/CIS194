...
how install [[https://github.com/haroldcarr/test-hunit-util][test-hunit-util]], small wrapper of Test.HUnit to make 
...
5. cabal repl  #to start ghci which loads sandbox packages as well
