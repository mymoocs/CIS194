{--
  ...
  Last Modified : 2016 Nov 27 (Sun) 03:46:04 PM by Arthur Vardanyan.
--}
...
testIntOrUppercase4 = runParser intOrUppercase "..." @?= Nothing-- main = defaultMain week10Tests



week10tests :: TestTree
week10tests = testGroup "week10 tests" [unitTests, properties]
...
unitTests = testGroup "Unit tests"
            [ testGroup "ex1/Functor"
              [ testCase "functor OK"   testFunctor1
              , testCase "functor fail" testFunctor2
              , QC.testProperty "functor rand" prop_Functor
              ]
            , testGroup "ex2/Applicative"
              [ testCase "applicative OK" testApp1
              , testCase "applicative fail" testApp2
              , testCase "applicative pure" testAppPure
              , QC.testProperty "applicative rand" prop_applicative
              ]
            , testGroup "ex3/Parsers"
              [ testCase "testAbParser1" testAbParser1
              , testCase "testAbParser2" testAbParser2
